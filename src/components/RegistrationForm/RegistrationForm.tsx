...
export const RegistrationForm = (): JSX.Element => {
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      await register(email, firstName, lastName, street, city, postalCode, country, password)
    } catch (error) {
  ...
  return (
    <Form className={['form']} onSubmit={onSubmit}>
      ...
      <fieldset>
        ...
        <TextInput name={'country'} label={'Country'} errors={countryErrors} onChange={onCountryChange} />
      </fieldset>
